...
if __name__ == "__main__":
    ...
    with open("config_1.yaml") as f:  #config.yaml
    ...
    # write graph
    nx.write_graphml_lxml(g, "./output/storagenx.graphml")

    # write db predata
    with open(os.path.join(BASE_DIR, 'output', 'db_predata.csv'), 'w', newline='') as csvfile:
